                ...
                if in2==1:
                    ...
                    if len(details)==0:
                        ...
                        for i in range(len(details)):
                            print("Product ID: "+str(details[i]["Product_id"]))
                            print("Product Title: "+str(details[i]["Product_Name"]))
                            print("Product Type: "+str(details[i]["Product_Type"]))
                            print("Price Per Day: "+str(details[i]["Price_per_day"]))
                            print("Total Stock Available: "+str(details[i]["total_stock"]))
                            print('\n')
                elif in2==4:
                    print("Enter Product ID")
                    Product_Id=input()
                    ...
                    if len(details)==0:
                        ...
                        for i in range(len(details)):
                            ...
                            for j in range(len(cart)):
                                print("  Product ID: "+str(cart[j]["Product_id"]))
                ...
                if in3==1:
                    ...
                    if len(l)==0:
                        ...
                        for i in range(len(l)):
                            print("Product ID: "+str(l[i]["Product_id"]))
                            print("Product Title: "+str(l[i]["Product_Name"]))
                            print("Product Type: "+str(l[i]["Product_Type"]))
                            print("Price Per Day: "+str(l[i]["Price_per_day"]))
                            print("Total Stock Available: "+str(l[i]["total_stock"]))
                            print('\n')
                        continue
                elif in3==2:
                    print("Press: ")
                    ...
                    if in31==2:
                        ...
                        if len(cart)==0:
                            ...
                            for i in range(len(cart)):
                                print("Product ID: "+str(cart[i]["Product_id"]))
